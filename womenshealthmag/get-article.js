/* @meta
{
  "name": "womenshealthmag/get-article",
  "description": "Read Women's Health article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.womenshealthmag.com",
  "args": {
    "url": { "required": true, "description": "Women's Health article URL (www.womenshealthmag.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site womenshealthmag/get-article https://www.womenshealthmag.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "womenshealthmag.com";
  var SITE_HOSTS = ["womenshealthmag.com","www.womenshealthmag.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Women's Health URL",
      hint: "Use an article link from www.womenshealthmag.com.",
      action: "bun-browser open https://www.womenshealthmag.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.womenshealthmag.com in Chrome first, then retry.",
