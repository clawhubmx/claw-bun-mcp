/* @meta
{
  "name": "theconversation/get-article",
  "description": "Read The Conversation article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.theconversation.com",
  "args": {
    "url": { "required": true, "description": "The Conversation article URL (www.theconversation.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site theconversation/get-article https://www.theconversation.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "theconversation.com";
  var SITE_HOSTS = ["theconversation.com","www.theconversation.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Conversation URL",
      hint: "Use an article link from www.theconversation.com.",
      action: "bun-browser open https://www.theconversation.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.theconversation.com in Chrome first, then retry.",
