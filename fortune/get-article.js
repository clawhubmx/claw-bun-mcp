/* @meta
{
  "name": "fortune/get-article",
  "description": "Read Fortune article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.fortune.com",
  "args": {
    "url": { "required": true, "description": "Fortune article URL (www.fortune.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site fortune/get-article https://www.fortune.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "fortune.com";
  var SITE_HOSTS = ["fortune.com","www.fortune.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Fortune URL",
      hint: "Use an article link from www.fortune.com.",
      action: "bun-browser open https://www.fortune.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.fortune.com in Chrome first, then retry.",
