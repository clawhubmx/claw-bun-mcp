/* @meta
{
  "name": "eurogamer/get-article",
  "description": "Read Eurogamer article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.eurogamer.net",
  "args": {
    "url": { "required": true, "description": "Eurogamer article URL (www.eurogamer.net)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site eurogamer/get-article https://www.eurogamer.net/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "eurogamer.net";
  var SITE_HOSTS = ["eurogamer.net","www.eurogamer.net"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Eurogamer URL",
      hint: "Use an article link from www.eurogamer.net.",
      action: "bun-browser open https://www.eurogamer.net",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.eurogamer.net in Chrome first, then retry.",
