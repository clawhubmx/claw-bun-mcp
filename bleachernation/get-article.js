/* @meta
{
  "name": "bleachernation/get-article",
  "description": "Read Bleacher Nation article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.bleachernation.com",
  "args": {
    "url": { "required": true, "description": "Bleacher Nation article URL (www.bleachernation.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site bleachernation/get-article https://www.bleachernation.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "bleachernation.com";
  ...
  var SITE_HOSTS = ["bleachernation.com","www.bleachernation.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Bleacher Nation URL",
      hint: "Use an article link from www.bleachernation.com.",
      action: "bun-browser open https://www.bleachernation.com",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      ...
      return {
        ...
        hint: "Article may be unavailable. Open www.bleachernation.com in Chrome first, then retry.",
