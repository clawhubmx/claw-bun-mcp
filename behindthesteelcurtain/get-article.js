/* @meta
{
  "name": "behindthesteelcurtain/get-article",
  "description": "Read Behind the Steel Curtain article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.behindthesteelcurtain.com",
  "args": {
    "url": { "required": true, "description": "Behind the Steel Curtain article URL (www.behindthesteelcurtain.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site behindthesteelcurtain/get-article https://www.behindthesteelcurtain.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "behindthesteelcurtain.com";
  var SITE_HOSTS = ["behindthesteelcurtain.com","www.behindthesteelcurtain.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Behind the Steel Curtain URL",
      hint: "Use an article link from www.behindthesteelcurtain.com.",
      action: "bun-browser open https://www.behindthesteelcurtain.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.behindthesteelcurtain.com in Chrome first, then retry.",
