/* @meta
{
  "name": "euronews/get-article",
  "description": "Read Euronews.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.euronews.com",
  "args": {
    "url": { "required": true, "description": "Euronews.com article URL (www.euronews.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site euronews/get-article https://www.euronews.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "euronews.com";
  var SITE_HOSTS = ["euronews.com","www.euronews.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Euronews.com URL",
      hint: "Use an article link from www.euronews.com.",
      action: "bun-browser open https://www.euronews.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.euronews.com in Chrome first, then retry.",
