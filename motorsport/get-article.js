/* @meta
{
  "name": "motorsport/get-article",
  "description": "Read Motorsport.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.motorsport.com",
  "args": {
    "url": { "required": true, "description": "Motorsport.com article URL (www.motorsport.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site motorsport/get-article https://www.motorsport.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "motorsport.com";
  var SITE_HOSTS = ["motorsport.com","www.motorsport.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Motorsport.com URL",
      hint: "Use an article link from www.motorsport.com.",
      action: "bun-browser open https://www.motorsport.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.motorsport.com in Chrome first, then retry.",
