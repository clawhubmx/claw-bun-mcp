/* @meta
{
  "name": "nz-news-yahoo-com/get-article",
  "description": "Read Yahoo News New Zealand article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "nz.news.yahoo.com",
  "args": {
    "url": { "required": true, "description": "Yahoo News New Zealand article URL (nz.news.yahoo.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nz-news-yahoo-com/get-article https://nz.news.yahoo.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "nz.news.yahoo.com";
  var SITE_HOSTS = ["nz.news.yahoo.com","www.nz.news.yahoo.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Yahoo News New Zealand URL",
      hint: "Use an article link from nz.news.yahoo.com.",
      action: "bun-browser open https://nz.news.yahoo.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open nz.news.yahoo.com in Chrome first, then retry.",
