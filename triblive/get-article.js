/* @meta
{
  "name": "triblive/get-article",
  "description": "Read TribLIVE.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.triblive.com",
  "args": {
    "url": { "required": true, "description": "TribLIVE.com article URL (www.triblive.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site triblive/get-article https://www.triblive.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "triblive.com";
  var SITE_HOSTS = ["triblive.com","www.triblive.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a TribLIVE.com URL",
      hint: "Use an article link from www.triblive.com.",
      action: "bun-browser open https://www.triblive.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.triblive.com in Chrome first, then retry.",
