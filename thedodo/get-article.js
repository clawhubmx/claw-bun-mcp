/* @meta
{
  "name": "thedodo/get-article",
  "description": "Read The Dodo article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.thedodo.com",
  "args": {
    "url": { "required": true, "description": "The Dodo article URL (www.thedodo.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site thedodo/get-article https://www.thedodo.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "thedodo.com";
  var SITE_HOSTS = ["thedodo.com","www.thedodo.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Dodo URL",
      hint: "Use an article link from www.thedodo.com.",
      action: "bun-browser open https://www.thedodo.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.thedodo.com in Chrome first, then retry.",
