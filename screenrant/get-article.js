/* @meta
{
  "name": "screenrant/get-article",
  "description": "Read ScreenRant article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.screenrant.com",
  "args": {
    "url": { "required": true, "description": "ScreenRant article URL (www.screenrant.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site screenrant/get-article https://www.screenrant.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "screenrant.com";
  var SITE_HOSTS = ["screenrant.com","www.screenrant.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a ScreenRant URL",
      hint: "Use an article link from www.screenrant.com.",
      action: "bun-browser open https://www.screenrant.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.screenrant.com in Chrome first, then retry.",
