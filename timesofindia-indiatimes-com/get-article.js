/* @meta
{
  "name": "timesofindia-indiatimes-com/get-article",
  "description": "Read The Times of India article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "timesofindia.indiatimes.com",
  "args": {
    "url": { "required": true, "description": "The Times of India article URL (timesofindia.indiatimes.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site timesofindia-indiatimes-com/get-article https://timesofindia.indiatimes.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "timesofindia.indiatimes.com";
  var SITE_HOSTS = ["timesofindia.indiatimes.com","www.timesofindia.indiatimes.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Times of India URL",
      hint: "Use an article link from timesofindia.indiatimes.com.",
      action: "bun-browser open https://timesofindia.indiatimes.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open timesofindia.indiatimes.com in Chrome first, then retry.",
