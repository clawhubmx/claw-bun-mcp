/* @meta
{
  "name": "sciencedaily/get-article",
  "description": "Read ScienceDaily article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.sciencedaily.com",
  "args": {
    "url": { "required": true, "description": "ScienceDaily article URL (www.sciencedaily.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site sciencedaily/get-article https://www.sciencedaily.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "sciencedaily.com";
  var SITE_HOSTS = ["sciencedaily.com","www.sciencedaily.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a ScienceDaily URL",
      hint: "Use an article link from www.sciencedaily.com.",
      action: "bun-browser open https://www.sciencedaily.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.sciencedaily.com in Chrome first, then retry.",
