/* @meta
{
  "name": "theguardian/get-article",
  "description": "Read The Guardian article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.theguardian.com",
  "args": {
    "url": { "required": true, "description": "The Guardian article URL (www.theguardian.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site theguardian/get-article https://www.theguardian.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "theguardian.com";
  var SITE_HOSTS = ["theguardian.com","www.theguardian.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Guardian URL",
      hint: "Use an article link from www.theguardian.com.",
      action: "bun-browser open https://www.theguardian.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.theguardian.com in Chrome first, then retry.",
