/* @meta
{
  "name": "mlb/get-article",
  "description": "Read MLB.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.mlb.com",
  "args": {
    "url": { "required": true, "description": "MLB.com article URL (www.mlb.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site mlb/get-article https://www.mlb.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "mlb.com";
  var SITE_HOSTS = ["mlb.com","www.mlb.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a MLB.com URL",
      hint: "Use an article link from www.mlb.com.",
      action: "bun-browser open https://www.mlb.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.mlb.com in Chrome first, then retry.",
