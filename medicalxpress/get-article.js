/* @meta
{
  "name": "medicalxpress/get-article",
  "description": "Read Medical Xpress article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.medicalxpress.com",
  "args": {
    "url": { "required": true, "description": "Medical Xpress article URL (www.medicalxpress.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site medicalxpress/get-article https://www.medicalxpress.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "medicalxpress.com";
  var SITE_HOSTS = ["medicalxpress.com","www.medicalxpress.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Medical Xpress URL",
      hint: "Use an article link from www.medicalxpress.com.",
      action: "bun-browser open https://www.medicalxpress.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.medicalxpress.com in Chrome first, then retry.",
