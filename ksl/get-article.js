/* @meta
{
  "name": "ksl/get-article",
  "description": "Read KSL News article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.ksl.com",
  "args": {
    "url": { "required": true, "description": "KSL News article URL (www.ksl.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site ksl/get-article https://www.ksl.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "ksl.com";
  var SITE_HOSTS = ["ksl.com","www.ksl.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a KSL News URL",
      hint: "Use an article link from www.ksl.com.",
      action: "bun-browser open https://www.ksl.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.ksl.com in Chrome first, then retry.",
