/* @meta
{
  "name": "universetoday/get-article",
  "description": "Read Universe Today article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.universetoday.com",
  "args": {
    "url": { "required": true, "description": "Universe Today article URL (www.universetoday.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site universetoday/get-article https://www.universetoday.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "universetoday.com";
  var SITE_HOSTS = ["universetoday.com","www.universetoday.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Universe Today URL",
      hint: "Use an article link from www.universetoday.com.",
      action: "bun-browser open https://www.universetoday.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.universetoday.com in Chrome first, then retry.",
