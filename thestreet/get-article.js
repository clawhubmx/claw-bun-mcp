/* @meta
{
  "name": "thestreet/get-article",
  "description": "Read thestreet.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.thestreet.com",
  "args": {
    "url": { "required": true, "description": "thestreet.com article URL (www.thestreet.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site thestreet/get-article https://www.thestreet.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "thestreet.com";
  var SITE_HOSTS = ["thestreet.com","www.thestreet.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a thestreet.com URL",
      hint: "Use an article link from www.thestreet.com.",
      action: "bun-browser open https://www.thestreet.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.thestreet.com in Chrome first, then retry.",
