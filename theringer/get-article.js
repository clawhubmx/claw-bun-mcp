/* @meta
{
  "name": "theringer/get-article",
  "description": "Read The Ringer article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.theringer.com",
  "args": {
    "url": { "required": true, "description": "The Ringer article URL (www.theringer.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site theringer/get-article https://www.theringer.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "theringer.com";
  var SITE_HOSTS = ["theringer.com","www.theringer.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Ringer URL",
      hint: "Use an article link from www.theringer.com.",
      action: "bun-browser open https://www.theringer.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.theringer.com in Chrome first, then retry.",
