/* @meta
{
  "name": "9to5mac/get-article",
  "description": "Read 9to5Mac article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.9to5mac.com",
  "args": {
    "url": { "required": true, "description": "9to5Mac article URL (www.9to5mac.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site 9to5mac/get-article https://www.9to5mac.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "9to5mac.com";
  var SITE_HOSTS = ["9to5mac.com","www.9to5mac.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a 9to5Mac URL",
      hint: "Use an article link from www.9to5mac.com.",
      action: "bun-browser open https://www.9to5mac.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.9to5mac.com in Chrome first, then retry.",
