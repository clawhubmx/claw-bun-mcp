/* @meta
{
  "name": "theurbanist/get-article",
  "description": "Read The Urbanist article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.theurbanist.org",
  "args": {
    "url": { "required": true, "description": "The Urbanist article URL (www.theurbanist.org)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site theurbanist/get-article https://www.theurbanist.org/"
}
*/
...
async function (args) {
  ...
  var SITE_HOSTS = ["theurbanist.org","www.theurbanist.org"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Urbanist URL",
      hint: "Use an article link from www.theurbanist.org.",
      action: "bun-browser open https://www.theurbanist.org",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      return {
        ...
        hint: "Article may be unavailable. Open www.theurbanist.org in Chrome first, then retry.",
