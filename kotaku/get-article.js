/* @meta
{
  "name": "kotaku/get-article",
  "description": "Read Kotaku article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.kotaku.com",
  "args": {
    "url": { "required": true, "description": "Kotaku article URL (www.kotaku.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site kotaku/get-article https://www.kotaku.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "kotaku.com";
  var SITE_HOSTS = ["kotaku.com","www.kotaku.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Kotaku URL",
      hint: "Use an article link from www.kotaku.com.",
      action: "bun-browser open https://www.kotaku.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.kotaku.com in Chrome first, then retry.",
