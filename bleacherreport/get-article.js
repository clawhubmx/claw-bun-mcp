/* @meta
{
  "name": "bleacherreport/get-article",
  "description": "Read Bleacher Report article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.bleacherreport.com",
  "args": {
    "url": { "required": true, "description": "Bleacher Report article URL (www.bleacherreport.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site bleacherreport/get-article https://www.bleacherreport.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "bleacherreport.com";
  var SITE_HOSTS = ["bleacherreport.com","www.bleacherreport.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Bleacher Report URL",
      hint: "Use an article link from www.bleacherreport.com.",
      action: "bun-browser open https://www.bleacherreport.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.bleacherreport.com in Chrome first, then retry.",
