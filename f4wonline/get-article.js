/* @meta
{
  "name": "f4wonline/get-article",
  "description": "Read F4W/WON article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.f4wonline.com",
  "args": {
    "url": { "required": true, "description": "F4W/WON article URL (www.f4wonline.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site f4wonline/get-article https://www.f4wonline.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "f4wonline.com";
  var SITE_HOSTS = ["f4wonline.com","www.f4wonline.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a F4W/WON URL",
      hint: "Use an article link from www.f4wonline.com.",
      action: "bun-browser open https://www.f4wonline.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.f4wonline.com in Chrome first, then retry.",
