/* @meta
{
  "name": "videocardz/get-article",
  "description": "Read VideoCardz.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.videocardz.com",
  "args": {
    "url": { "required": true, "description": "VideoCardz.com article URL (www.videocardz.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site videocardz/get-article https://www.videocardz.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "videocardz.com";
  var SITE_HOSTS = ["videocardz.com","www.videocardz.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a VideoCardz.com URL",
      hint: "Use an article link from www.videocardz.com.",
      action: "bun-browser open https://www.videocardz.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.videocardz.com in Chrome first, then retry.",
