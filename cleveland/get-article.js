/* @meta
{
  "name": "cleveland/get-article",
  "description": "Read Cleveland.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.cleveland.com",
  "args": {
    "url": { "required": true, "description": "Cleveland.com article URL (www.cleveland.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site cleveland/get-article https://www.cleveland.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "cleveland.com";
  var SITE_HOSTS = ["cleveland.com","www.cleveland.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Cleveland.com URL",
      hint: "Use an article link from www.cleveland.com.",
      action: "bun-browser open https://www.cleveland.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.cleveland.com in Chrome first, then retry.",
