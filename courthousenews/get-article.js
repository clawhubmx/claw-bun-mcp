/* @meta
{
  "name": "courthousenews/get-article",
  "description": "Read Courthouse News article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.courthousenews.com",
  "args": {
    "url": { "required": true, "description": "Courthouse News article URL (www.courthousenews.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site courthousenews/get-article https://www.courthousenews.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "courthousenews.com";
  ...
  var SITE_HOSTS = ["courthousenews.com","www.courthousenews.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Courthouse News URL",
      hint: "Use an article link from www.courthousenews.com.",
      action: "bun-browser open https://www.courthousenews.com",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      return {
        ...
        hint: "Article may be unavailable. Open www.courthousenews.com in Chrome first, then retry.",
