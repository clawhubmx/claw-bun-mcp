/* @meta
{
  "name": "slate/get-article",
  "description": "Read Slate Magazine article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.slate.com",
  "args": {
    "url": { "required": true, "description": "Slate Magazine article URL (www.slate.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site slate/get-article https://www.slate.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "slate.com";
  var SITE_HOSTS = ["slate.com","www.slate.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Slate Magazine URL",
      hint: "Use an article link from www.slate.com.",
      action: "bun-browser open https://www.slate.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.slate.com in Chrome first, then retry.",
