...
{
  "name": "si/get-article",
  "description": "Read Sports Illustrated article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.si.com",
  "args": {
    "url": { "required": true, "description": "Sports Illustrated article URL (www.si.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site si/get-article https://www.si.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "si.com";
  var SITE_HOSTS = ["si.com","www.si.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Sports Illustrated URL",
      hint: "Use an article link from www.si.com.",
      action: "bun-browser open https://www.si.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.si.com in Chrome first, then retry.",
