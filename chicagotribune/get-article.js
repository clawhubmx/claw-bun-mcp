/* @meta
{
  "name": "chicagotribune/get-article",
  "description": "Read Chicago Tribune article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.chicagotribune.com",
  "args": {
    "url": { "required": true, "description": "Chicago Tribune article URL (www.chicagotribune.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site chicagotribune/get-article https://www.chicagotribune.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "chicagotribune.com";
  var SITE_HOSTS = ["chicagotribune.com","www.chicagotribune.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Chicago Tribune URL",
      hint: "Use an article link from www.chicagotribune.com.",
      action: "bun-browser open https://www.chicagotribune.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.chicagotribune.com in Chrome first, then retry.",
