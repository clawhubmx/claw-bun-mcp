/* @meta
{
  "name": "insider-gaming/get-article",
  "description": "Read Insider Gaming article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.insider-gaming.com",
  "args": {
    "url": { "required": true, "description": "Insider Gaming article URL (www.insider-gaming.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site insider-gaming/get-article https://www.insider-gaming.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "insider-gaming.com";
  var SITE_HOSTS = ["insider-gaming.com","www.insider-gaming.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Insider Gaming URL",
      hint: "Use an article link from www.insider-gaming.com.",
      action: "bun-browser open https://www.insider-gaming.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.insider-gaming.com in Chrome first, then retry.",
