/* @meta
{
  "name": "thehackernews/get-article",
  "description": "Read The Hacker News article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.thehackernews.com",
  "args": {
    "url": { "required": true, "description": "The Hacker News article URL (www.thehackernews.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site thehackernews/get-article https://www.thehackernews.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "thehackernews.com";
  var SITE_HOSTS = ["thehackernews.com","www.thehackernews.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Hacker News URL",
      hint: "Use an article link from www.thehackernews.com.",
      action: "bun-browser open https://www.thehackernews.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.thehackernews.com in Chrome first, then retry.",
