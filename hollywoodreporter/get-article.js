/* @meta
{
  "name": "hollywoodreporter/get-article",
  "description": "Read The Hollywood Reporter article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.hollywoodreporter.com",
  "args": {
    "url": { "required": true, "description": "The Hollywood Reporter article URL (www.hollywoodreporter.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site hollywoodreporter/get-article https://www.hollywoodreporter.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "hollywoodreporter.com";
  ...
  var SITE_HOSTS = ["hollywoodreporter.com","www.hollywoodreporter.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Hollywood Reporter URL",
      hint: "Use an article link from www.hollywoodreporter.com.",
      action: "bun-browser open https://www.hollywoodreporter.com",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      return {
        ...
        hint: "Article may be unavailable. Open www.hollywoodreporter.com in Chrome first, then retry.",
