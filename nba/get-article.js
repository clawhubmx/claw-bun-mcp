/* @meta
{
  "name": "nba/get-article",
  "description": "Read NBA.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.nba.com",
  "args": {
    "url": { "required": true, "description": "NBA.com article URL (www.nba.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nba/get-article https://www.nba.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "nba.com";
  var SITE_HOSTS = ["nba.com","www.nba.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a NBA.com URL",
      hint: "Use an article link from www.nba.com.",
      action: "bun-browser open https://www.nba.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.nba.com in Chrome first, then retry.",
