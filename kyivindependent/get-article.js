/* @meta
{
  "name": "kyivindependent/get-article",
  "description": "Read The Kyiv Independent article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.kyivindependent.com",
  "args": {
    "url": { "required": true, "description": "The Kyiv Independent article URL (www.kyivindependent.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site kyivindependent/get-article https://www.kyivindependent.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "kyivindependent.com";
  var SITE_HOSTS = ["kyivindependent.com","www.kyivindependent.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Kyiv Independent URL",
      hint: "Use an article link from www.kyivindependent.com.",
      action: "bun-browser open https://www.kyivindependent.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.kyivindependent.com in Chrome first, then retry.",
