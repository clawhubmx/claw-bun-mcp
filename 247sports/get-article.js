/* @meta
{
  "name": "247sports/get-article",
  "description": "Read 247Sports article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.247sports.com",
  "args": {
    "url": { "required": true, "description": "247Sports article URL (www.247sports.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site 247sports/get-article https://www.247sports.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "247sports.com";
  var SITE_HOSTS = ["247sports.com","www.247sports.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a 247Sports URL",
      hint: "Use an article link from www.247sports.com.",
      action: "bun-browser open https://www.247sports.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.247sports.com in Chrome first, then retry.",
