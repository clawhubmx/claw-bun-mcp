/* @meta
{
  "name": "onemileatatime/get-article",
  "description": "Read One Mile at a Time article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.onemileatatime.com",
  "args": {
    "url": { "required": true, "description": "One Mile at a Time article URL (www.onemileatatime.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site onemileatatime/get-article https://www.onemileatatime.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "onemileatatime.com";
  var SITE_HOSTS = ["onemileatatime.com","www.onemileatatime.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a One Mile at a Time URL",
      hint: "Use an article link from www.onemileatatime.com.",
      action: "bun-browser open https://www.onemileatatime.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.onemileatatime.com in Chrome first, then retry.",
