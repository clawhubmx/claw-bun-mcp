/* @meta
{
  "name": "tech-yahoo-com/get-article",
  "description": "Read Yahoo Tech article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "tech.yahoo.com",
  "args": {
    "url": { "required": true, "description": "Yahoo Tech article URL (tech.yahoo.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site tech-yahoo-com/get-article https://tech.yahoo.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "tech.yahoo.com";
  var SITE_HOSTS = ["tech.yahoo.com","www.tech.yahoo.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Yahoo Tech URL",
      hint: "Use an article link from tech.yahoo.com.",
      action: "bun-browser open https://tech.yahoo.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open tech.yahoo.com in Chrome first, then retry.",
