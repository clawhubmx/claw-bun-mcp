/* @meta
{
  "name": "forbes/get-article",
  "description": "Read Forbes article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.forbes.com",
  "args": {
    "url": { "required": true, "description": "Forbes article URL (www.forbes.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site forbes/get-article https://www.forbes.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "forbes.com";
  var SITE_HOSTS = ["forbes.com","www.forbes.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Forbes URL",
      hint: "Use an article link from www.forbes.com.",
      action: "bun-browser open https://www.forbes.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.forbes.com in Chrome first, then retry.",
