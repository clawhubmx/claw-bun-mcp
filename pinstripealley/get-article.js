/* @meta
{
  "name": "pinstripealley/get-article",
  "description": "Read Pinstripe Alley article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.pinstripealley.com",
  "args": {
    "url": { "required": true, "description": "Pinstripe Alley article URL (www.pinstripealley.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site pinstripealley/get-article https://www.pinstripealley.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "pinstripealley.com";
  var SITE_HOSTS = ["pinstripealley.com","www.pinstripealley.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Pinstripe Alley URL",
      hint: "Use an article link from www.pinstripealley.com.",
      action: "bun-browser open https://www.pinstripealley.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.pinstripealley.com in Chrome first, then retry.",
