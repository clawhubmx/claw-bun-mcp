/* @meta
{
  "name": "understandingwar/get-article",
  "description": "Read Institute for the Study of War article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.understandingwar.org",
  "args": {
    "url": { "required": true, "description": "Institute for the Study of War article URL (www.understandingwar.org)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site understandingwar/get-article https://www.understandingwar.org/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "understandingwar.org";
  var SITE_HOSTS = ["understandingwar.org","www.understandingwar.org"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Institute for the Study of War URL",
      hint: "Use an article link from www.understandingwar.org.",
      action: "bun-browser open https://www.understandingwar.org",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.understandingwar.org in Chrome first, then retry.",
