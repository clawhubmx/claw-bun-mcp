/* @meta
{
  "name": "abovethelaw/get-article",
  "description": "Read Above the Law article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.abovethelaw.com",
  "args": {
    "url": { "required": true, "description": "Above the Law article URL (www.abovethelaw.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site abovethelaw/get-article https://www.abovethelaw.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "abovethelaw.com";
  var SITE_HOSTS = ["abovethelaw.com","www.abovethelaw.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Above the Law URL",
      hint: "Use an article link from www.abovethelaw.com.",
      action: "bun-browser open https://www.abovethelaw.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.abovethelaw.com in Chrome first, then retry.",
