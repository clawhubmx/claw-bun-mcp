/* @meta
{
  "name": "opb/get-article",
  "description": "Read Oregon Public Broadcasting - OPB article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.opb.org",
  "args": {
    "url": { "required": true, "description": "Oregon Public Broadcasting - OPB article URL (www.opb.org)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site opb/get-article https://www.opb.org/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "opb.org";
  var SITE_HOSTS = ["opb.org","www.opb.org"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Oregon Public Broadcasting - OPB URL",
      hint: "Use an article link from www.opb.org.",
      action: "bun-browser open https://www.opb.org",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.opb.org in Chrome first, then retry.",
