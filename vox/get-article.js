/* @meta
{
  "name": "vox/get-article",
  "description": "Read vox.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.vox.com",
  "args": {
    "url": { "required": true, "description": "vox.com article URL (www.vox.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site vox/get-article https://www.vox.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "vox.com";
  var SITE_HOSTS = ["vox.com","www.vox.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a vox.com URL",
      hint: "Use an article link from www.vox.com.",
      action: "bun-browser open https://www.vox.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.vox.com in Chrome first, then retry.",
