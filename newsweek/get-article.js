/* @meta
{
  "name": "newsweek/get-article",
  "description": "Read Newsweek article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.newsweek.com",
  "args": {
    "url": { "required": true, "description": "Newsweek article URL (www.newsweek.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site newsweek/get-article https://www.newsweek.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "newsweek.com";
  var SITE_HOSTS = ["newsweek.com","www.newsweek.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Newsweek URL",
      hint: "Use an article link from www.newsweek.com.",
      action: "bun-browser open https://www.newsweek.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.newsweek.com in Chrome first, then retry.",
