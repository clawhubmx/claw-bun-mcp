/* @meta
{
  "name": "wdwnt/get-article",
  "description": "Read WDW News Today article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.wdwnt.com",
  "args": {
    "url": { "required": true, "description": "WDW News Today article URL (www.wdwnt.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site wdwnt/get-article https://www.wdwnt.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "wdwnt.com";
  var SITE_HOSTS = ["wdwnt.com","www.wdwnt.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a WDW News Today URL",
      hint: "Use an article link from www.wdwnt.com.",
      action: "bun-browser open https://www.wdwnt.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.wdwnt.com in Chrome first, then retry.",
