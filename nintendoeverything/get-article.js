/* @meta
{
  "name": "nintendoeverything/get-article",
  "description": "Read Nintendo Everything article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.nintendoeverything.com",
  "args": {
    "url": { "required": true, "description": "Nintendo Everything article URL (www.nintendoeverything.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nintendoeverything/get-article https://www.nintendoeverything.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "nintendoeverything.com";
  ...
  var SITE_HOSTS = ["nintendoeverything.com","www.nintendoeverything.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Nintendo Everything URL",
      hint: "Use an article link from www.nintendoeverything.com.",
      action: "bun-browser open https://www.nintendoeverything.com",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      return {
        ...
        hint: "Article may be unavailable. Open www.nintendoeverything.com in Chrome first, then retry.",
