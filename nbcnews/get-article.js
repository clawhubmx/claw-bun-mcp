/* @meta
{
  "name": "nbcnews/get-article",
  "description": "Read NBC News article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.nbcnews.com",
  "args": {
    "url": { "required": true, "description": "NBC News article URL (www.nbcnews.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nbcnews/get-article https://www.nbcnews.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "nbcnews.com";
  var SITE_HOSTS = ["nbcnews.com","www.nbcnews.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a NBC News URL",
      hint: "Use an article link from www.nbcnews.com.",
      action: "bun-browser open https://www.nbcnews.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.nbcnews.com in Chrome first, then retry.",
