/* @meta
{
  "name": "timesofisrael/get-article",
  "description": "Read The Times of Israel article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.timesofisrael.com",
  "args": {
    "url": { "required": true, "description": "The Times of Israel article URL (www.timesofisrael.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site timesofisrael/get-article https://www.timesofisrael.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "timesofisrael.com";
  var SITE_HOSTS = ["timesofisrael.com","www.timesofisrael.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Times of Israel URL",
      hint: "Use an article link from www.timesofisrael.com.",
      action: "bun-browser open https://www.timesofisrael.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.timesofisrael.com in Chrome first, then retry.",
