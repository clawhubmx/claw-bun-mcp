/* @meta
{
  "name": "gamesindustry/get-article",
  "description": "Read GamesIndustry.biz article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.gamesindustry.biz",
  "args": {
    "url": { "required": true, "description": "GamesIndustry.biz article URL (www.gamesindustry.biz)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site gamesindustry/get-article https://www.gamesindustry.biz/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "gamesindustry.biz";
  var SITE_HOSTS = ["gamesindustry.biz","www.gamesindustry.biz"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a GamesIndustry.biz URL",
      hint: "Use an article link from www.gamesindustry.biz.",
      action: "bun-browser open https://www.gamesindustry.biz",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.gamesindustry.biz in Chrome first, then retry.",
