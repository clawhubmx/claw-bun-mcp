/* @meta
{
  "name": "aljazeera/get-article",
  "description": "Read Al Jazeera article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.aljazeera.com",
  "args": {
    "url": { "required": true, "description": "Al Jazeera article URL (www.aljazeera.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site aljazeera/get-article https://www.aljazeera.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "aljazeera.com";
  var SITE_HOSTS = ["aljazeera.com","www.aljazeera.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Al Jazeera URL",
      hint: "Use an article link from www.aljazeera.com.",
      action: "bun-browser open https://www.aljazeera.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.aljazeera.com in Chrome first, then retry.",
