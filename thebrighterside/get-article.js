/* @meta
{
  "name": "thebrighterside/get-article",
  "description": "Read The Brighter Side of News article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.thebrighterside.news",
  "args": {
    "url": { "required": true, "description": "The Brighter Side of News article URL (www.thebrighterside.news)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site thebrighterside/get-article https://www.thebrighterside.news/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "thebrighterside.news";
  var SITE_HOSTS = ["thebrighterside.news","www.thebrighterside.news"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Brighter Side of News URL",
      hint: "Use an article link from www.thebrighterside.news.",
      action: "bun-browser open https://www.thebrighterside.news",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.thebrighterside.news in Chrome first, then retry.",
