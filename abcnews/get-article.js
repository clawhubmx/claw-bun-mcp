/* @meta
{
  "name": "abcnews/get-article",
  "description": "Read ABC News - Breaking News, Latest News and Videos article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.abcnews.com",
  "args": {
    "url": { "required": true, "description": "ABC News - Breaking News, Latest News and Videos article URL (www.abcnews.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site abcnews/get-article https://www.abcnews.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "abcnews.com";
  var SITE_HOSTS = ["abcnews.com","www.abcnews.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a ABC News - Breaking News, Latest News and Videos URL",
      hint: "Use an article link from www.abcnews.com.",
      action: "bun-browser open https://www.abcnews.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.abcnews.com in Chrome first, then retry.",
