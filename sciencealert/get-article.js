/* @meta
{
  "name": "sciencealert/get-article",
  "description": "Read ScienceAlert article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.sciencealert.com",
  "args": {
    "url": { "required": true, "description": "ScienceAlert article URL (www.sciencealert.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site sciencealert/get-article https://www.sciencealert.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "sciencealert.com";
  var SITE_HOSTS = ["sciencealert.com","www.sciencealert.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a ScienceAlert URL",
      hint: "Use an article link from www.sciencealert.com.",
      action: "bun-browser open https://www.sciencealert.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.sciencealert.com in Chrome first, then retry.",
