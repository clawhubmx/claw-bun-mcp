/* @meta
{
  "name": "russianmachineneverbreaks/get-article",
  "description": "Read RMNB article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.russianmachineneverbreaks.com",
  "args": {
    "url": { "required": true, "description": "RMNB article URL (www.russianmachineneverbreaks.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site russianmachineneverbreaks/get-article https://www.russianmachineneverbreaks.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "russianmachineneverbreaks.com";
  var SITE_HOSTS = ["russianmachineneverbreaks.com","www.russianmachineneverbreaks.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a RMNB URL",
      hint: "Use an article link from www.russianmachineneverbreaks.com.",
      action: "bun-browser open https://www.russianmachineneverbreaks.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.russianmachineneverbreaks.com in Chrome first, then retry.",
