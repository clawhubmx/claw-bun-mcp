/* @meta
{
  "name": "inews/get-article",
  "description": "Read The i Paper article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.inews.co.uk",
  "args": {
    "url": { "required": true, "description": "The i Paper article URL (www.inews.co.uk)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site inews/get-article https://www.inews.co.uk/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "inews.co.uk";
  var SITE_HOSTS = ["inews.co.uk","www.inews.co.uk"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The i Paper URL",
      hint: "Use an article link from www.inews.co.uk.",
      action: "bun-browser open https://www.inews.co.uk",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.inews.co.uk in Chrome first, then retry.",
