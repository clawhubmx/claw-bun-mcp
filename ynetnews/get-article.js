/* @meta
{
  "name": "ynetnews/get-article",
  "description": "Read Ynetnews article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.ynetnews.com",
  "args": {
    "url": { "required": true, "description": "Ynetnews article URL (www.ynetnews.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site ynetnews/get-article https://www.ynetnews.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "ynetnews.com";
  var SITE_HOSTS = ["ynetnews.com","www.ynetnews.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Ynetnews URL",
      hint: "Use an article link from www.ynetnews.com.",
      action: "bun-browser open https://www.ynetnews.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.ynetnews.com in Chrome first, then retry.",
