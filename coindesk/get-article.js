/* @meta
{
  "name": "coindesk/get-article",
  "description": "Read CoinDesk article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.coindesk.com",
  "args": {
    "url": { "required": true, "description": "CoinDesk article URL (www.coindesk.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site coindesk/get-article https://www.coindesk.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "coindesk.com";
  var SITE_HOSTS = ["coindesk.com","www.coindesk.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a CoinDesk URL",
      hint: "Use an article link from www.coindesk.com.",
      action: "bun-browser open https://www.coindesk.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.coindesk.com in Chrome first, then retry.",
