/* @meta
{
  "name": "asiatimes/get-article",
  "description": "Read Asia Times article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.asiatimes.com",
  "args": {
    "url": { "required": true, "description": "Asia Times article URL (www.asiatimes.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site asiatimes/get-article https://www.asiatimes.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "asiatimes.com";
  var SITE_HOSTS = ["asiatimes.com","www.asiatimes.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Asia Times URL",
      hint: "Use an article link from www.asiatimes.com.",
      action: "bun-browser open https://www.asiatimes.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.asiatimes.com in Chrome first, then retry.",
