/* @meta
{
  "name": "gothamist/get-article",
  "description": "Read Gothamist article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.gothamist.com",
  "args": {
    "url": { "required": true, "description": "Gothamist article URL (www.gothamist.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site gothamist/get-article https://www.gothamist.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "gothamist.com";
  var SITE_HOSTS = ["gothamist.com","www.gothamist.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Gothamist URL",
      hint: "Use an article link from www.gothamist.com.",
      action: "bun-browser open https://www.gothamist.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.gothamist.com in Chrome first, then retry.",
