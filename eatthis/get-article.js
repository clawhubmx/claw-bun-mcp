/* @meta
{
  "name": "eatthis/get-article",
  "description": "Read Eat This Not That article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.eatthis.com",
  "args": {
    "url": { "required": true, "description": "Eat This Not That article URL (www.eatthis.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site eatthis/get-article https://www.eatthis.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "eatthis.com";
  var SITE_HOSTS = ["eatthis.com","www.eatthis.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Eat This Not That URL",
      hint: "Use an article link from www.eatthis.com.",
      action: "bun-browser open https://www.eatthis.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.eatthis.com in Chrome first, then retry.",
