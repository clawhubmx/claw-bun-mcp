/* @meta
{
  "name": "goal/get-article",
  "description": "Read Goal.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.goal.com",
  "args": {
    "url": { "required": true, "description": "Goal.com article URL (www.goal.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site goal/get-article https://www.goal.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "goal.com";
  var SITE_HOSTS = ["goal.com","www.goal.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Goal.com URL",
      hint: "Use an article link from www.goal.com.",
      action: "bun-browser open https://www.goal.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.goal.com in Chrome first, then retry.",
