/* @meta
{
  "name": "liveandletsfly/get-article",
  "description": "Read Live and Let's Fly article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.liveandletsfly.com",
  "args": {
    "url": { "required": true, "description": "Live and Let's Fly article URL (www.liveandletsfly.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site liveandletsfly/get-article https://www.liveandletsfly.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "liveandletsfly.com";
  var SITE_HOSTS = ["liveandletsfly.com","www.liveandletsfly.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Live and Let's Fly URL",
      hint: "Use an article link from www.liveandletsfly.com.",
      action: "bun-browser open https://www.liveandletsfly.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.liveandletsfly.com in Chrome first, then retry.",
