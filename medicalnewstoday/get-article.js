/* @meta
{
  "name": "medicalnewstoday/get-article",
  "description": "Read Medical News Today article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.medicalnewstoday.com",
  "args": {
    "url": { "required": true, "description": "Medical News Today article URL (www.medicalnewstoday.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site medicalnewstoday/get-article https://www.medicalnewstoday.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "medicalnewstoday.com";
  var SITE_HOSTS = ["medicalnewstoday.com","www.medicalnewstoday.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Medical News Today URL",
      hint: "Use an article link from www.medicalnewstoday.com.",
      action: "bun-browser open https://www.medicalnewstoday.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.medicalnewstoday.com in Chrome first, then retry.",
