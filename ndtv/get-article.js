/* @meta
{
  "name": "ndtv/get-article",
  "description": "Read NDTV article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.ndtv.com",
  "args": {
    "url": { "required": true, "description": "NDTV article URL (www.ndtv.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site ndtv/get-article https://www.ndtv.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "ndtv.com";
  var SITE_HOSTS = ["ndtv.com","www.ndtv.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a NDTV URL",
      hint: "Use an article link from www.ndtv.com.",
      action: "bun-browser open https://www.ndtv.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.ndtv.com in Chrome first, then retry.",
