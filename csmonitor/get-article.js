/* @meta
{
  "name": "csmonitor/get-article",
  "description": "Read The Christian Science Monitor article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.csmonitor.com",
  "args": {
    "url": { "required": true, "description": "The Christian Science Monitor article URL (www.csmonitor.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site csmonitor/get-article https://www.csmonitor.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "csmonitor.com";
  var SITE_HOSTS = ["csmonitor.com","www.csmonitor.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Christian Science Monitor URL",
      hint: "Use an article link from www.csmonitor.com.",
      action: "bun-browser open https://www.csmonitor.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.csmonitor.com in Chrome first, then retry.",
