/* @meta
{
  "name": "investors/get-article",
  "description": "Read Investor's Business Daily article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.investors.com",
  "args": {
    "url": { "required": true, "description": "Investor's Business Daily article URL (www.investors.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site investors/get-article https://www.investors.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "investors.com";
  var SITE_HOSTS = ["investors.com","www.investors.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Investor's Business Daily URL",
      hint: "Use an article link from www.investors.com.",
      action: "bun-browser open https://www.investors.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.investors.com in Chrome first, then retry.",
