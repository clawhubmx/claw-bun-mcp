/* @meta
{
  "name": "eatingwell/get-article",
  "description": "Read EatingWell article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.eatingwell.com",
  "args": {
    "url": { "required": true, "description": "EatingWell article URL (www.eatingwell.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site eatingwell/get-article https://www.eatingwell.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "eatingwell.com";
  var SITE_HOSTS = ["eatingwell.com","www.eatingwell.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a EatingWell URL",
      hint: "Use an article link from www.eatingwell.com.",
      action: "bun-browser open https://www.eatingwell.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.eatingwell.com in Chrome first, then retry.",
