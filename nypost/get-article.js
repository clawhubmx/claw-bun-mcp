/* @meta
{
  "name": "nypost/get-article",
  "description": "Read New York Post article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.nypost.com",
  "args": {
    "url": { "required": true, "description": "New York Post article URL (www.nypost.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nypost/get-article https://www.nypost.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "nypost.com";
  var SITE_HOSTS = ["nypost.com","www.nypost.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a New York Post URL",
      hint: "Use an article link from www.nypost.com.",
      action: "bun-browser open https://www.nypost.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.nypost.com in Chrome first, then retry.",
