/* @meta
{
  "name": "gameinformer/get-article",
  "description": "Read Game Informer article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.gameinformer.com",
  "args": {
    "url": { "required": true, "description": "Game Informer article URL (www.gameinformer.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site gameinformer/get-article https://www.gameinformer.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "gameinformer.com";
  var SITE_HOSTS = ["gameinformer.com","www.gameinformer.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Game Informer URL",
      hint: "Use an article link from www.gameinformer.com.",
      action: "bun-browser open https://www.gameinformer.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.gameinformer.com in Chrome first, then retry.",
