/* @meta
{
  "name": "creators-yahoo-com/get-article",
  "description": "Read Yahoo Creators article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "creators.yahoo.com",
  "args": {
    "url": { "required": true, "description": "Yahoo Creators article URL (creators.yahoo.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site creators-yahoo-com/get-article https://creators.yahoo.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "creators.yahoo.com";
  var SITE_HOSTS = ["creators.yahoo.com","www.creators.yahoo.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Yahoo Creators URL",
      hint: "Use an article link from creators.yahoo.com.",
      action: "bun-browser open https://creators.yahoo.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open creators.yahoo.com in Chrome first, then retry.",
