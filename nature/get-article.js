/* @meta
{
  "name": "nature/get-article",
  "description": "Read Nature article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.nature.com",
  "args": {
    "url": { "required": true, "description": "Nature article URL (www.nature.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nature/get-article https://www.nature.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "nature.com";
  var SITE_HOSTS = ["nature.com","www.nature.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Nature URL",
      hint: "Use an article link from www.nature.com.",
      action: "bun-browser open https://www.nature.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.nature.com in Chrome first, then retry.",
