/* @meta
{
  "name": "sports-yahoo-com/get-article",
  "description": "Read Yahoo Sports article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "sports.yahoo.com",
  "args": {
    "url": { "required": true, "description": "Yahoo Sports article URL (sports.yahoo.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site sports-yahoo-com/get-article https://sports.yahoo.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "sports.yahoo.com";
  ...
  var SITE_HOSTS = ["sports.yahoo.com","www.sports.yahoo.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Yahoo Sports URL",
      hint: "Use an article link from sports.yahoo.com.",
      action: "bun-browser open https://sports.yahoo.com",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      return {
        ...
        hint: "Article may be unavailable. Open sports.yahoo.com in Chrome first, then retry.",
