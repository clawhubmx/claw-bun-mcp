/* @meta
{
  "name": "scmp/get-article",
  "description": "Read South China Morning Post article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.scmp.com",
  "args": {
    "url": { "required": true, "description": "South China Morning Post article URL (www.scmp.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site scmp/get-article https://www.scmp.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "scmp.com";
  var SITE_HOSTS = ["scmp.com","www.scmp.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a South China Morning Post URL",
      hint: "Use an article link from www.scmp.com.",
      action: "bun-browser open https://www.scmp.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.scmp.com in Chrome first, then retry.",
