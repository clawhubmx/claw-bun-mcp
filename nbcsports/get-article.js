/* @meta
{
  "name": "nbcsports/get-article",
  "description": "Read NBC Sports article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.nbcsports.com",
  "args": {
    "url": { "required": true, "description": "NBC Sports article URL (www.nbcsports.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nbcsports/get-article https://www.nbcsports.com/"
}
*/
...
async function (args) {
  ...
  var SITE_HOSTS = ["nbcsports.com","www.nbcsports.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a NBC Sports URL",
      hint: "Use an article link from www.nbcsports.com.",
      action: "bun-browser open https://www.nbcsports.com",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      return {
        ...
        hint: "Article may be unavailable. Open www.nbcsports.com in Chrome first, then retry.",
