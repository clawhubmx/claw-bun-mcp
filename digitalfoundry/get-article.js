/* @meta
{
  "name": "digitalfoundry/get-article",
  "description": "Read Digital Foundry article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.digitalfoundry.net",
  "args": {
    "url": { "required": true, "description": "Digital Foundry article URL (www.digitalfoundry.net)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site digitalfoundry/get-article https://www.digitalfoundry.net/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "digitalfoundry.net";
  var SITE_HOSTS = ["digitalfoundry.net","www.digitalfoundry.net"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Digital Foundry URL",
      hint: "Use an article link from www.digitalfoundry.net.",
      action: "bun-browser open https://www.digitalfoundry.net",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.digitalfoundry.net in Chrome first, then retry.",
