/* @meta
{
  "name": "news-xbox-com/get-article",
  "description": "Read XBOX Wire article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "news.xbox.com",
  "args": {
    "url": { "required": true, "description": "XBOX Wire article URL (news.xbox.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site news-xbox-com/get-article https://news.xbox.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "news.xbox.com";
  var SITE_HOSTS = ["news.xbox.com","www.news.xbox.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a XBOX Wire URL",
      hint: "Use an article link from news.xbox.com.",
      action: "bun-browser open https://news.xbox.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open news.xbox.com in Chrome first, then retry.",
