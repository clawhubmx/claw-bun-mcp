/* @meta
{
  "name": "prnewswire/get-article",
  "description": "Read PR Newswire article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.prnewswire.com",
  "args": {
    "url": { "required": true, "description": "PR Newswire article URL (www.prnewswire.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site prnewswire/get-article https://www.prnewswire.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "prnewswire.com";
  var SITE_HOSTS = ["prnewswire.com","www.prnewswire.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a PR Newswire URL",
      hint: "Use an article link from www.prnewswire.com.",
      action: "bun-browser open https://www.prnewswire.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.prnewswire.com in Chrome first, then retry.",
