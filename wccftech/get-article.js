/* @meta
{
  "name": "wccftech/get-article",
  "description": "Read Wccftech article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.wccftech.com",
  "args": {
    "url": { "required": true, "description": "Wccftech article URL (www.wccftech.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site wccftech/get-article https://www.wccftech.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "wccftech.com";
  var SITE_HOSTS = ["wccftech.com","www.wccftech.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Wccftech URL",
      hint: "Use an article link from www.wccftech.com.",
      action: "bun-browser open https://www.wccftech.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.wccftech.com in Chrome first, then retry.",
