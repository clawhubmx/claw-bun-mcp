/* @meta
{
  "name": "futurism/get-article",
  "description": "Read Futurism article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.futurism.com",
  "args": {
    "url": { "required": true, "description": "Futurism article URL (www.futurism.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site futurism/get-article https://www.futurism.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "futurism.com";
  var SITE_HOSTS = ["futurism.com","www.futurism.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Futurism URL",
      hint: "Use an article link from www.futurism.com.",
      action: "bun-browser open https://www.futurism.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.futurism.com in Chrome first, then retry.",
