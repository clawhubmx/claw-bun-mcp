/* @meta
{
  "name": "9to5google/get-article",
  "description": "Read 9to5Google article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.9to5google.com",
  "args": {
    "url": { "required": true, "description": "9to5Google article URL (www.9to5google.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site 9to5google/get-article https://www.9to5google.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "9to5google.com";
  var SITE_HOSTS = ["9to5google.com","www.9to5google.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a 9to5Google URL",
      hint: "Use an article link from www.9to5google.com.",
      action: "bun-browser open https://www.9to5google.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.9to5google.com in Chrome first, then retry.",
