/* @meta
{
  "name": "nhl/get-article",
  "description": "Read NHL.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.nhl.com",
  "args": {
    "url": { "required": true, "description": "NHL.com article URL (www.nhl.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site nhl/get-article https://www.nhl.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "nhl.com";
  var SITE_HOSTS = ["nhl.com","www.nhl.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a NHL.com URL",
      hint: "Use an article link from www.nhl.com.",
      action: "bun-browser open https://www.nhl.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.nhl.com in Chrome first, then retry.",
