/* @meta
{
  "name": "scitechdaily/get-article",
  "description": "Read SciTechDaily article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.scitechdaily.com",
  "args": {
    "url": { "required": true, "description": "SciTechDaily article URL (www.scitechdaily.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site scitechdaily/get-article https://www.scitechdaily.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "scitechdaily.com";
  var SITE_HOSTS = ["scitechdaily.com","www.scitechdaily.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a SciTechDaily URL",
      hint: "Use an article link from www.scitechdaily.com.",
      action: "bun-browser open https://www.scitechdaily.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.scitechdaily.com in Chrome first, then retry.",
