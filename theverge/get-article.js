/* @meta
{
  "name": "theverge/get-article",
  "description": "Read The Verge article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.theverge.com",
  "args": {
    "url": { "required": true, "description": "The Verge article URL (www.theverge.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site theverge/get-article https://www.theverge.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "theverge.com";
  var SITE_HOSTS = ["theverge.com","www.theverge.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a The Verge URL",
      hint: "Use an article link from www.theverge.com.",
      action: "bun-browser open https://www.theverge.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.theverge.com in Chrome first, then retry.",
