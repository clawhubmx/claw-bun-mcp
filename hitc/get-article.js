/* @meta
{
  "name": "hitc/get-article",
  "description": "Read hitc.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.hitc.com",
  "args": {
    "url": { "required": true, "description": "hitc.com article URL (www.hitc.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site hitc/get-article https://www.hitc.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "hitc.com";
  var SITE_HOSTS = ["hitc.com","www.hitc.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a hitc.com URL",
      hint: "Use an article link from www.hitc.com.",
      action: "bun-browser open https://www.hitc.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.hitc.com in Chrome first, then retry.",
