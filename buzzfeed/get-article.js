/* @meta
{
  "name": "buzzfeed/get-article",
  "description": "Read BuzzFeed article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.buzzfeed.com",
  "args": {
    "url": { "required": true, "description": "BuzzFeed article URL (www.buzzfeed.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site buzzfeed/get-article https://www.buzzfeed.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "buzzfeed.com";
  var SITE_HOSTS = ["buzzfeed.com","www.buzzfeed.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a BuzzFeed URL",
      hint: "Use an article link from www.buzzfeed.com.",
      action: "bun-browser open https://www.buzzfeed.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.buzzfeed.com in Chrome first, then retry.",
