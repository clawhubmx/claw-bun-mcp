/* @meta
{
  "name": "mmafighting/get-article",
  "description": "Read MMA Fighting article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.mmafighting.com",
  "args": {
    "url": { "required": true, "description": "MMA Fighting article URL (www.mmafighting.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site mmafighting/get-article https://www.mmafighting.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "mmafighting.com";
  var SITE_HOSTS = ["mmafighting.com","www.mmafighting.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a MMA Fighting URL",
      hint: "Use an article link from www.mmafighting.com.",
      action: "bun-browser open https://www.mmafighting.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.mmafighting.com in Chrome first, then retry.",
