/* @meta
{
  "name": "aol/get-article",
  "description": "Read AOL.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.aol.com",
  "args": {
    "url": { "required": true, "description": "AOL.com article URL (www.aol.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site aol/get-article https://www.aol.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "aol.com";
  var SITE_HOSTS = ["aol.com","www.aol.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a AOL.com URL",
      hint: "Use an article link from www.aol.com.",
      action: "bun-browser open https://www.aol.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.aol.com in Chrome first, then retry.",
