/* @meta
{
  "name": "cowboystatedaily/get-article",
  "description": "Read Cowboy State Daily article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.cowboystatedaily.com",
  "args": {
    "url": { "required": true, "description": "Cowboy State Daily article URL (www.cowboystatedaily.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site cowboystatedaily/get-article https://www.cowboystatedaily.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "cowboystatedaily.com";
  var SITE_HOSTS = ["cowboystatedaily.com","www.cowboystatedaily.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Cowboy State Daily URL",
      hint: "Use an article link from www.cowboystatedaily.com.",
      action: "bun-browser open https://www.cowboystatedaily.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.cowboystatedaily.com in Chrome first, then retry.",
