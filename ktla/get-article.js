/* @meta
{
  "name": "ktla/get-article",
  "description": "Read KTLA article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.ktla.com",
  "args": {
    "url": { "required": true, "description": "KTLA article URL (www.ktla.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site ktla/get-article https://www.ktla.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "ktla.com";
  var SITE_HOSTS = ["ktla.com","www.ktla.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a KTLA URL",
      hint: "Use an article link from www.ktla.com.",
      action: "bun-browser open https://www.ktla.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.ktla.com in Chrome first, then retry.",
