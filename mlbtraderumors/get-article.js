/* @meta
{
  "name": "mlbtraderumors/get-article",
  "description": "Read MLB Trade Rumors article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.mlbtraderumors.com",
  "args": {
    "url": { "required": true, "description": "MLB Trade Rumors article URL (www.mlbtraderumors.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site mlbtraderumors/get-article https://www.mlbtraderumors.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "mlbtraderumors.com";
  ...
  var SITE_HOSTS = ["mlbtraderumors.com","www.mlbtraderumors.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a MLB Trade Rumors URL",
      hint: "Use an article link from www.mlbtraderumors.com.",
      action: "bun-browser open https://www.mlbtraderumors.com",
    };
  }
  ...
  if (!state.articleBody || !state.title) {
    ...
    if (!resp.ok) {
      return {
        ...
        hint: "Article may be unavailable. Open www.mlbtraderumors.com in Chrome first, then retry.",
