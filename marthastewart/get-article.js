/* @meta
{
  "name": "marthastewart/get-article",
  "description": "Read marthastewart.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.marthastewart.com",
  "args": {
    "url": { "required": true, "description": "marthastewart.com article URL (www.marthastewart.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site marthastewart/get-article https://www.marthastewart.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "marthastewart.com";
  var SITE_HOSTS = ["marthastewart.com","www.marthastewart.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a marthastewart.com URL",
      hint: "Use an article link from www.marthastewart.com.",
      action: "bun-browser open https://www.marthastewart.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.marthastewart.com in Chrome first, then retry.",
