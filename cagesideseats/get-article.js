/* @meta
{
  "name": "cagesideseats/get-article",
  "description": "Read cagesideseats.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.cagesideseats.com",
  "args": {
    "url": { "required": true, "description": "cagesideseats.com article URL (www.cagesideseats.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site cagesideseats/get-article https://www.cagesideseats.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "cagesideseats.com";
  var SITE_HOSTS = ["cagesideseats.com","www.cagesideseats.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a cagesideseats.com URL",
      hint: "Use an article link from www.cagesideseats.com.",
      action: "bun-browser open https://www.cagesideseats.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.cagesideseats.com in Chrome first, then retry.",
