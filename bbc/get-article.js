/* @meta
{
  "name": "bbc/get-article",
  "description": "Read BBC article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.bbc.com",
  "args": {
    "url": { "required": true, "description": "BBC article URL (www.bbc.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site bbc/get-article https://www.bbc.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "bbc.com";
  var SITE_HOSTS = ["bbc.com","www.bbc.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a BBC URL",
      hint: "Use an article link from www.bbc.com.",
      action: "bun-browser open https://www.bbc.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.bbc.com in Chrome first, then retry.",
