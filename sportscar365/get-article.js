/* @meta
{
  "name": "sportscar365/get-article",
  "description": "Read Sportscar365 article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.sportscar365.com",
  "args": {
    "url": { "required": true, "description": "Sportscar365 article URL (www.sportscar365.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site sportscar365/get-article https://www.sportscar365.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "sportscar365.com";
  var SITE_HOSTS = ["sportscar365.com","www.sportscar365.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Sportscar365 URL",
      hint: "Use an article link from www.sportscar365.com.",
      action: "bun-browser open https://www.sportscar365.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.sportscar365.com in Chrome first, then retry.",
