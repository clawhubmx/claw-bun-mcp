/* @meta
{
  "name": "techcrunch/get-article",
  "description": "Read TechCrunch article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.techcrunch.com",
  "args": {
    "url": { "required": true, "description": "TechCrunch article URL (www.techcrunch.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site techcrunch/get-article https://www.techcrunch.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "techcrunch.com";
  var SITE_HOSTS = ["techcrunch.com","www.techcrunch.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a TechCrunch URL",
      hint: "Use an article link from www.techcrunch.com.",
      action: "bun-browser open https://www.techcrunch.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.techcrunch.com in Chrome first, then retry.",
