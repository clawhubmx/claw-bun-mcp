/* @meta
{
  "name": "livescience/get-article",
  "description": "Read Live Science article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.livescience.com",
  "args": {
    "url": { "required": true, "description": "Live Science article URL (www.livescience.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site livescience/get-article https://www.livescience.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "livescience.com";
  var SITE_HOSTS = ["livescience.com","www.livescience.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Live Science URL",
      hint: "Use an article link from www.livescience.com.",
      action: "bun-browser open https://www.livescience.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.livescience.com in Chrome first, then retry.",
