/* @meta
{
  "name": "gamespress/get-article",
  "description": "Read Games Press article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.gamespress.com",
  "args": {
    "url": { "required": true, "description": "Games Press article URL (www.gamespress.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site gamespress/get-article https://www.gamespress.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "gamespress.com";
  var SITE_HOSTS = ["gamespress.com","www.gamespress.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Games Press URL",
      hint: "Use an article link from www.gamespress.com.",
      action: "bun-browser open https://www.gamespress.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.gamespress.com in Chrome first, then retry.",
