...
{
  "name": "al/get-article",
  "description": "Read AL.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.al.com",
  "args": {
    "url": { "required": true, "description": "AL.com article URL (www.al.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site al/get-article https://www.al.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "al.com";
  var SITE_HOSTS = ["al.com","www.al.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a AL.com URL",
      hint: "Use an article link from www.al.com.",
      action: "bun-browser open https://www.al.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.al.com in Chrome first, then retry.",
