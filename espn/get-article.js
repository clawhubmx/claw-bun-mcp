/* @meta
{
  "name": "espn/get-article",
  "description": "Read ESPN article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.espn.com",
  "args": {
    "url": { "required": true, "description": "ESPN article URL (www.espn.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site espn/get-article https://www.espn.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "espn.com";
  var SITE_HOSTS = ["espn.com","www.espn.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a ESPN URL",
      hint: "Use an article link from www.espn.com.",
      action: "bun-browser open https://www.espn.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.espn.com in Chrome first, then retry.",
