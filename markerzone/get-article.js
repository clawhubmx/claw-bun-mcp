/* @meta
{
  "name": "markerzone/get-article",
  "description": "Read MarkerZone.com article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.markerzone.com",
  "args": {
    "url": { "required": true, "description": "MarkerZone.com article URL (www.markerzone.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site markerzone/get-article https://www.markerzone.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "markerzone.com";
  var SITE_HOSTS = ["markerzone.com","www.markerzone.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a MarkerZone.com URL",
      hint: "Use an article link from www.markerzone.com.",
      action: "bun-browser open https://www.markerzone.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.markerzone.com in Chrome first, then retry.",
