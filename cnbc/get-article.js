/* @meta
{
  "name": "cnbc/get-article",
  "description": "Read CNBC article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.cnbc.com",
  "args": {
    "url": { "required": true, "description": "CNBC article URL (www.cnbc.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site cnbc/get-article https://www.cnbc.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "cnbc.com";
  var SITE_HOSTS = ["cnbc.com","www.cnbc.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a CNBC URL",
      hint: "Use an article link from www.cnbc.com.",
      action: "bun-browser open https://www.cnbc.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.cnbc.com in Chrome first, then retry.",
