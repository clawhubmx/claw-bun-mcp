/* @meta
{
  "name": "huffpost/get-article",
  "description": "Read HuffPost article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.huffpost.com",
  "args": {
    "url": { "required": true, "description": "HuffPost article URL (www.huffpost.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site huffpost/get-article https://www.huffpost.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "huffpost.com";
  var SITE_HOSTS = ["huffpost.com","www.huffpost.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a HuffPost URL",
      hint: "Use an article link from www.huffpost.com.",
      action: "bun-browser open https://www.huffpost.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.huffpost.com in Chrome first, then retry.",
