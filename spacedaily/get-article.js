/* @meta
{
  "name": "spacedaily/get-article",
  "description": "Read Space Daily article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.spacedaily.com",
  "args": {
    "url": { "required": true, "description": "Space Daily article URL (www.spacedaily.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site spacedaily/get-article https://www.spacedaily.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "spacedaily.com";
  var SITE_HOSTS = ["spacedaily.com","www.spacedaily.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Space Daily URL",
      hint: "Use an article link from www.spacedaily.com.",
      action: "bun-browser open https://www.spacedaily.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.spacedaily.com in Chrome first, then retry.",
