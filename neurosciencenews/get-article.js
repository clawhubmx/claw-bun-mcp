/* @meta
{
  "name": "neurosciencenews/get-article",
  "description": "Read Neuroscience News article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.neurosciencenews.com",
  "args": {
    "url": { "required": true, "description": "Neuroscience News article URL (www.neurosciencenews.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site neurosciencenews/get-article https://www.neurosciencenews.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "neurosciencenews.com";
  var SITE_HOSTS = ["neurosciencenews.com","www.neurosciencenews.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Neuroscience News URL",
      hint: "Use an article link from www.neurosciencenews.com.",
      action: "bun-browser open https://www.neurosciencenews.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.neurosciencenews.com in Chrome first, then retry.",
