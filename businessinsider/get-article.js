/* @meta
{
  "name": "businessinsider/get-article",
  "description": "Read Business Insider article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.businessinsider.com",
  "args": {
    "url": { "required": true, "description": "Business Insider article URL (www.businessinsider.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site businessinsider/get-article https://www.businessinsider.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "businessinsider.com";
  var SITE_HOSTS = ["businessinsider.com","www.businessinsider.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Business Insider URL",
      hint: "Use an article link from www.businessinsider.com.",
      action: "bun-browser open https://www.businessinsider.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.businessinsider.com in Chrome first, then retry.",
