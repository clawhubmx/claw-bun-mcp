/* @meta
{
  "name": "boingboing/get-article",
  "description": "Read Boing Boing article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.boingboing.net",
  "args": {
    "url": { "required": true, "description": "Boing Boing article URL (www.boingboing.net)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site boingboing/get-article https://www.boingboing.net/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "boingboing.net";
  var SITE_HOSTS = ["boingboing.net","www.boingboing.net"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Boing Boing URL",
      hint: "Use an article link from www.boingboing.net.",
      action: "bun-browser open https://www.boingboing.net",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.boingboing.net in Chrome first, then retry.",
