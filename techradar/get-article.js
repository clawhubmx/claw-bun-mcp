/* @meta
{
  "name": "techradar/get-article",
  "description": "Read TechRadar article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.techradar.com",
  "args": {
    "url": { "required": true, "description": "TechRadar article URL (www.techradar.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site techradar/get-article https://www.techradar.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "techradar.com";
  var SITE_HOSTS = ["techradar.com","www.techradar.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a TechRadar URL",
      hint: "Use an article link from www.techradar.com.",
      action: "bun-browser open https://www.techradar.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.techradar.com in Chrome first, then retry.",
