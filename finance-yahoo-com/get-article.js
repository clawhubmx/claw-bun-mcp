/* @meta
{
  "name": "finance-yahoo-com/get-article",
  "description": "Read Yahoo Finance article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "finance.yahoo.com",
  "args": {
    "url": { "required": true, "description": "Yahoo Finance article URL (finance.yahoo.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site finance-yahoo-com/get-article https://finance.yahoo.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "finance.yahoo.com";
  var SITE_HOSTS = ["finance.yahoo.com","www.finance.yahoo.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Yahoo Finance URL",
      hint: "Use an article link from finance.yahoo.com.",
      action: "bun-browser open https://finance.yahoo.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open finance.yahoo.com in Chrome first, then retry.",
