/* @meta
{
  "name": "autosport/get-article",
  "description": "Read Autosport article title, author, date, and body. Uses JSON-LD NewsArticle metadata and generic article DOM extraction.",
  "domain": "www.autosport.com",
  "args": {
    "url": { "required": true, "description": "Autosport article URL (www.autosport.com)" }
  },
  "capabilities": ["network"],
  "readOnly": true,
  "example": "bun-browser site autosport/get-article https://www.autosport.com/"
}
*/
...
async function (args) {
  ...
  var SITE_ROOT = "autosport.com";
  var SITE_HOSTS = ["autosport.com","www.autosport.com"];
  ...
  if (!isSiteHostname(parsedUrl.hostname)) {
    return {
      error: "Not a Autosport URL",
      hint: "Use an article link from www.autosport.com.",
      action: "bun-browser open https://www.autosport.com",
    };
  }
    ...
    if (!resp.ok) {
      ...
      if (!resp.ok) {
        return {
          ...
          hint: "Article may be unavailable. Open www.autosport.com in Chrome first, then retry.",
